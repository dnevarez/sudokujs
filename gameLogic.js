          ...
          if ( !$nextSquare ) {
              ...
              return true;
                ...
                for ( var i = 0; i < legalValues.length; i++ ) {
                      ...
                      this.matrix.sect[sectCol][sectRow] = cval;
                ...
                // numbers, call bactrack recursivley backwards
                return false;
          }
    },
     ...
     */
     ...
     findLegalValuesForSquare: function( row, col ) {
          var legalVals, legalNums, val, i,
              ...
              // Check existing number in section
              sectRow = Math.floor( row / 3 );
              sectCol = Math.floor( col / 3 );
              for ( i = 0; i < 9; i++ ) {
